...
func TestConsole_consoleArgText_Ugly(t *testing.T) {
	...
	if !core.Contains(got, `"nested":true`) {
...
func TestConsole_ExceptionWatcherTrimsOldExceptions_Good(t *testing.T) {
	ExceptionWatcherTrimsOldExceptions := "ExceptionWatcherTrimsOldExceptions"
	if len(ExceptionWatcherTrimsOldExceptions) == 0 {
		t.Fatal(ExceptionWatcherTrimsOldExceptions)
	}
...
func TestConsole_NewConsoleWatcher_Bad(t *testing.T) {
	symbolName := "NewConsoleWatcher"
	variantName := "Bad"
...
func TestConsole_NewConsoleWatcher_Ugly(t *testing.T) {
	symbolName := "NewConsoleWatcher"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_AddFilter_Good(t *testing.T) {
	symbolName := "ConsoleWatcher AddFilter"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_AddFilter_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher AddFilter"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_AddFilter_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher AddFilter"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_ClearFilters_Good(t *testing.T) {
	symbolName := "ConsoleWatcher ClearFilters"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_ClearFilters_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher ClearFilters"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_ClearFilters_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher ClearFilters"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_AddHandler_Good(t *testing.T) {
	symbolName := "ConsoleWatcher AddHandler"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_AddHandler_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher AddHandler"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_AddHandler_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher AddHandler"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_SetLimit_Good(t *testing.T) {
	symbolName := "ConsoleWatcher SetLimit"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_SetLimit_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher SetLimit"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_SetLimit_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher SetLimit"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Messages_Good(t *testing.T) {
	symbolName := "ConsoleWatcher Messages"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_Messages_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher Messages"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Messages_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher Messages"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_MessagesAll_Good(t *testing.T) {
	symbolName := "ConsoleWatcher MessagesAll"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_MessagesAll_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher MessagesAll"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_MessagesAll_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher MessagesAll"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_FilteredMessages_Good(t *testing.T) {
	symbolName := "ConsoleWatcher FilteredMessages"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_FilteredMessages_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher FilteredMessages"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_FilteredMessages_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher FilteredMessages"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_FilteredMessagesAll_Good(t *testing.T) {
	symbolName := "ConsoleWatcher FilteredMessagesAll"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_FilteredMessagesAll_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher FilteredMessagesAll"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_FilteredMessagesAll_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher FilteredMessagesAll"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Errors_Good(t *testing.T) {
	symbolName := "ConsoleWatcher Errors"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_Errors_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher Errors"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Errors_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher Errors"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_ErrorsAll_Good(t *testing.T) {
	symbolName := "ConsoleWatcher ErrorsAll"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_ErrorsAll_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher ErrorsAll"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_ErrorsAll_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher ErrorsAll"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Warnings_Good(t *testing.T) {
	symbolName := "ConsoleWatcher Warnings"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_Warnings_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher Warnings"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Warnings_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher Warnings"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_WarningsAll_Good(t *testing.T) {
	symbolName := "ConsoleWatcher WarningsAll"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_WarningsAll_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher WarningsAll"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_WarningsAll_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher WarningsAll"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Clear_Good(t *testing.T) {
	symbolName := "ConsoleWatcher Clear"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_Clear_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher Clear"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Clear_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher Clear"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_WaitForMessage_Good(t *testing.T) {
	symbolName := "ConsoleWatcher WaitForMessage"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_WaitForMessage_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher WaitForMessage"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_WaitForMessage_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher WaitForMessage"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_WaitForError_Good(t *testing.T) {
	symbolName := "ConsoleWatcher WaitForError"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_WaitForError_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher WaitForError"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_WaitForError_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher WaitForError"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_HasErrors_Good(t *testing.T) {
	symbolName := "ConsoleWatcher HasErrors"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_HasErrors_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher HasErrors"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_HasErrors_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher HasErrors"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Count_Good(t *testing.T) {
	symbolName := "ConsoleWatcher Count"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_Count_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher Count"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_Count_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher Count"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_ErrorCount_Good(t *testing.T) {
	symbolName := "ConsoleWatcher ErrorCount"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ConsoleWatcher_ErrorCount_Bad(t *testing.T) {
	symbolName := "ConsoleWatcher ErrorCount"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ConsoleWatcher_ErrorCount_Ugly(t *testing.T) {
	symbolName := "ConsoleWatcher ErrorCount"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_NewExceptionWatcher_Bad(t *testing.T) {
	symbolName := "NewExceptionWatcher"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_NewExceptionWatcher_Ugly(t *testing.T) {
	symbolName := "NewExceptionWatcher"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_Exceptions_Good(t *testing.T) {
	symbolName := "ExceptionWatcher Exceptions"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ExceptionWatcher_Exceptions_Bad(t *testing.T) {
	symbolName := "ExceptionWatcher Exceptions"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_Exceptions_Ugly(t *testing.T) {
	symbolName := "ExceptionWatcher Exceptions"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_ExceptionsAll_Good(t *testing.T) {
	symbolName := "ExceptionWatcher ExceptionsAll"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ExceptionWatcher_ExceptionsAll_Bad(t *testing.T) {
	symbolName := "ExceptionWatcher ExceptionsAll"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_ExceptionsAll_Ugly(t *testing.T) {
	symbolName := "ExceptionWatcher ExceptionsAll"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_Clear_Good(t *testing.T) {
	symbolName := "ExceptionWatcher Clear"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ExceptionWatcher_Clear_Bad(t *testing.T) {
	symbolName := "ExceptionWatcher Clear"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_Clear_Ugly(t *testing.T) {
	symbolName := "ExceptionWatcher Clear"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_HasExceptions_Good(t *testing.T) {
	symbolName := "ExceptionWatcher HasExceptions"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ExceptionWatcher_HasExceptions_Bad(t *testing.T) {
	symbolName := "ExceptionWatcher HasExceptions"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_HasExceptions_Ugly(t *testing.T) {
	symbolName := "ExceptionWatcher HasExceptions"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_Count_Good(t *testing.T) {
	symbolName := "ExceptionWatcher Count"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ExceptionWatcher_Count_Bad(t *testing.T) {
	symbolName := "ExceptionWatcher Count"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_Count_Ugly(t *testing.T) {
	symbolName := "ExceptionWatcher Count"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_AddHandler_Good(t *testing.T) {
	symbolName := "ExceptionWatcher AddHandler"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ExceptionWatcher_AddHandler_Bad(t *testing.T) {
	symbolName := "ExceptionWatcher AddHandler"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_AddHandler_Ugly(t *testing.T) {
	symbolName := "ExceptionWatcher AddHandler"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_WaitForException_Good(t *testing.T) {
	symbolName := "ExceptionWatcher WaitForException"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_ExceptionWatcher_WaitForException_Bad(t *testing.T) {
	symbolName := "ExceptionWatcher WaitForException"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_ExceptionWatcher_WaitForException_Ugly(t *testing.T) {
	symbolName := "ExceptionWatcher WaitForException"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_FormatConsoleOutput_Good(t *testing.T) {
	symbolName := "FormatConsoleOutput"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestConsole_FormatConsoleOutput_Bad(t *testing.T) {
	symbolName := "FormatConsoleOutput"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestConsole_FormatConsoleOutput_Ugly(t *testing.T) {
	symbolName := "FormatConsoleOutput"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
