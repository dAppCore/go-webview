...
func TestAngular_WaitForAngular_Good(t *testing.T) {
	...
	ah, _, _ := newAngularTestHarness(t, func(target *fakeCDPTarget, msg cdpMessage) {
		...
		if core.Contains(expr, "getAllAngularRootElements") || core.Contains(expr, "[ng-version]") {
...
func TestAngular_waitForZoneStability_Good_FallsBackToPolling(t *testing.T) {
	...
	ah, _, _ := newAngularTestHarness(t, func(target *fakeCDPTarget, msg cdpMessage) {
		...
		expr, _ := msg.Params["expression"].(string)
		switch {
		case core.Contains(expr, "new Promise"):
...
func TestAngular_NavigateByRouter_Good(t *testing.T) {
	...
	ah, _, _ := newAngularTestHarness(t, func(target *fakeCDPTarget, msg cdpMessage) {
		...
		if core.Contains(expr, "navigateByUrl") {
			target.replyValue(msg.ID, true)
			return
		}
		target.replyValue(msg.ID, true)
...
func TestAngular_GetComponentProperty_Good(t *testing.T) {
	ah, _, _ := newAngularTestHarness(t, func(target *fakeCDPTarget, msg cdpMessage) {
		...
		expr, _ := msg.Params["expression"].(string)
		if !core.Contains(expr, `const selector = "app-user";`) {
			t.Fatalf("expression did not quote selector: %s", expr)
		}
		if !core.Contains(expr, `const propertyName = "displayName";`) {
...
func TestAngular_SetComponentProperty_Good(t *testing.T) {
	ah, _, _ := newAngularTestHarness(t, func(target *fakeCDPTarget, msg cdpMessage) {
		...
		expr, _ := msg.Params["expression"].(string)
		if !core.Contains(expr, `component[propertyName] = true;`) {
...
func TestAngular_CallComponentMethod_Good(t *testing.T) {
	ah, _, _ := newAngularTestHarness(t, func(target *fakeCDPTarget, msg cdpMessage) {
		...
		expr, _ := msg.Params["expression"].(string)
		if !core.Contains(expr, `component[methodName](1, "two")`) {
...
func TestAngular_DispatchEvent_Good(t *testing.T) {
	ah, _, _ := newAngularTestHarness(t, func(target *fakeCDPTarget, msg cdpMessage) {
		...
		expr, _ := msg.Params["expression"].(string)
		if !core.Contains(expr, `new CustomEvent(eventName, { bubbles: true, detail: {"count":1} })`) && !core.Contains(expr, `new CustomEvent(eventName, { bubbles: true, detail: {\"count\":1} })`) {
...
func TestAngular_formatJSValue_Ugly_FallsBackToSprint(t *testing.T) {
	...
	if !core.HasPrefix(got, "\"") || !core.HasSuffix(got, "\"") {
		t.Fatalf("formatJSValue fallback = %q, want quoted string output", got)
	}
}

func TestAngular_NewAngularHelper_Good(t *testing.T) {
	symbolName := "NewAngularHelper"
	variantName := "Good"
...
func TestAngular_NewAngularHelper_Bad(t *testing.T) {
	symbolName := "NewAngularHelper"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_NewAngularHelper_Ugly(t *testing.T) {
	symbolName := "NewAngularHelper"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_SetTimeout_Good(t *testing.T) {
	symbolName := "AngularHelper SetTimeout"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_SetTimeout_Bad(t *testing.T) {
	symbolName := "AngularHelper SetTimeout"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_SetTimeout_Ugly(t *testing.T) {
	symbolName := "AngularHelper SetTimeout"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_WaitForAngular_Good(t *testing.T) {
	symbolName := "AngularHelper WaitForAngular"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_WaitForAngular_Bad(t *testing.T) {
	symbolName := "AngularHelper WaitForAngular"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_WaitForAngular_Ugly(t *testing.T) {
	symbolName := "AngularHelper WaitForAngular"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_NavigateByRouter_Good(t *testing.T) {
	symbolName := "AngularHelper NavigateByRouter"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_NavigateByRouter_Bad(t *testing.T) {
	symbolName := "AngularHelper NavigateByRouter"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_NavigateByRouter_Ugly(t *testing.T) {
	symbolName := "AngularHelper NavigateByRouter"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_GetRouterState_Good(t *testing.T) {
	symbolName := "AngularHelper GetRouterState"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_GetRouterState_Bad(t *testing.T) {
	symbolName := "AngularHelper GetRouterState"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_GetRouterState_Ugly(t *testing.T) {
	symbolName := "AngularHelper GetRouterState"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_GetComponentProperty_Good(t *testing.T) {
	symbolName := "AngularHelper GetComponentProperty"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_GetComponentProperty_Bad(t *testing.T) {
	symbolName := "AngularHelper GetComponentProperty"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_GetComponentProperty_Ugly(t *testing.T) {
	symbolName := "AngularHelper GetComponentProperty"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_SetComponentProperty_Good(t *testing.T) {
	symbolName := "AngularHelper SetComponentProperty"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_SetComponentProperty_Bad(t *testing.T) {
	symbolName := "AngularHelper SetComponentProperty"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_SetComponentProperty_Ugly(t *testing.T) {
	symbolName := "AngularHelper SetComponentProperty"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_CallComponentMethod_Good(t *testing.T) {
	symbolName := "AngularHelper CallComponentMethod"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_CallComponentMethod_Bad(t *testing.T) {
	symbolName := "AngularHelper CallComponentMethod"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_CallComponentMethod_Ugly(t *testing.T) {
	symbolName := "AngularHelper CallComponentMethod"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_TriggerChangeDetection_Good(t *testing.T) {
	symbolName := "AngularHelper TriggerChangeDetection"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_TriggerChangeDetection_Bad(t *testing.T) {
	symbolName := "AngularHelper TriggerChangeDetection"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_TriggerChangeDetection_Ugly(t *testing.T) {
	symbolName := "AngularHelper TriggerChangeDetection"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_GetService_Good(t *testing.T) {
	symbolName := "AngularHelper GetService"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_GetService_Bad(t *testing.T) {
	symbolName := "AngularHelper GetService"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_GetService_Ugly(t *testing.T) {
	symbolName := "AngularHelper GetService"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_WaitForComponent_Good(t *testing.T) {
	symbolName := "AngularHelper WaitForComponent"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_WaitForComponent_Bad(t *testing.T) {
	symbolName := "AngularHelper WaitForComponent"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_WaitForComponent_Ugly(t *testing.T) {
	symbolName := "AngularHelper WaitForComponent"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_DispatchEvent_Good(t *testing.T) {
	symbolName := "AngularHelper DispatchEvent"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_DispatchEvent_Bad(t *testing.T) {
	symbolName := "AngularHelper DispatchEvent"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_DispatchEvent_Ugly(t *testing.T) {
	symbolName := "AngularHelper DispatchEvent"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_GetNgModel_Good(t *testing.T) {
	symbolName := "AngularHelper GetNgModel"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_GetNgModel_Bad(t *testing.T) {
	symbolName := "AngularHelper GetNgModel"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_GetNgModel_Ugly(t *testing.T) {
	symbolName := "AngularHelper GetNgModel"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_SetNgModel_Good(t *testing.T) {
	symbolName := "AngularHelper SetNgModel"
	variantName := "Good"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
	}
...
func TestAngular_AngularHelper_SetNgModel_Bad(t *testing.T) {
	symbolName := "AngularHelper SetNgModel"
	variantName := "Bad"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
...
func TestAngular_AngularHelper_SetNgModel_Ugly(t *testing.T) {
	symbolName := "AngularHelper SetNgModel"
	variantName := "Ugly"
	if core.Contains(symbolName, "\x00") {
		t.Fatalf("%s contains an impossible marker", symbolName)
